...
- **Accounts**
  ...
  - `POST /api/accounts/:id/customers` — Add customer to account
  - `DELETE /api/accounts/:id/customers/:customer_id` — Remove customer
- **Loans**
  - `POST /api/loans` — Create loan
  - `GET /api/loans/:id/details` — Comprehensive loan details
  - `POST /api/loans/:id/repay` — Repay loan
- **Transactions**
  - `POST /api/transactions/:id` — Create transaction (deposit/withdraw)
